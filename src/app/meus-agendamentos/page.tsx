  ...
  if (client) {
    appointments = await prisma.appointment.findMany({
      ...
      include: {
        ...
        service: true,
        reviews: true, // inclui reviews para saber se já avaliou
      },
              ...
              {past.map(app => {
                ...
                return (
                  <div key={app.id} className="bg-[#0a0a0a] border border-zinc-800/50 rounded-2xl p-6 hover:border-zinc-700 transition-colors">
                    ...
                    <div className="pt-4 border-t border-zinc-800/50 flex justify-between items-center mb-0">
                    ...
                    {/* FORM DE AVALIAÇÃO — só aparece se concluído e ainda não avaliado */}
                    {canReview && (
                      <ReviewWrapper
                        appointmentId={app.id}
                        barberName={app.barber.user.name}
                      />
                    )}
                  </div>
                );
